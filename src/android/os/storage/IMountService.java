...
//            }
            ...
            public String getUUID(String path) throws RemoteException
            {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String _result;
            ...
            public java.util.List<android.os.storage.ExtraInfo> getAllExtraInfos() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                java.util.List<android.os.storage.ExtraInfo> _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_getAllExtraInfos, _data, _reply, 0);
                    _reply.readException();
            ...
            public String mountISO(String path) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                String _result;
                try {
       ...
       public void unmountISO(String path) throws RemoteException {
        Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
        ...
        static final int TRANSACTION_getAllExtraInfos = IBinder.FIRST_CALL_TRANSACTION + 35;

        static final int TRANSACTION_mountISO = IBinder.FIRST_CALL_TRANSACTION + 36;

        static final int TRANSACTION_getUUID = IBinder.FIRST_CALL_TRANSACTION + 37;

        static final int TRANSACTION_unmountISO = IBinder.FIRST_CALL_TRANSACTION + 38;
...
//                }
                ...
                case TRANSACTION_getAllExtraInfos: {
                    data.enforceInterface(DESCRIPTOR);
                    java.util.List<android.os.storage.ExtraInfo> result = this.getAllExtraInfos();
                    reply.writeNoException();
                ...
                case TRANSACTION_mountISO: {
                    data.enforceInterface(DESCRIPTOR);
                    String path = data.readString();
                    String result = this.mountISO(path);
                    reply.writeNoException();
                ...
                case TRANSACTION_getUUID: {
                    data.enforceInterface(DESCRIPTOR);
                    String path = data.readString();
                    String result = this.getUUID(path);
                    reply.writeNoException();
                    reply.writeString(result);
                    return true;
                }
